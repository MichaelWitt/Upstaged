                ...
                >
                  <Card.Body>
                    <iframe
                      width="100%"
                      height="100%"
                      src="https://www.youtube.com/embed/videoseries?list=PLiy0XOfUv4hGKvbULOvGBDPcYc6mOjwJX"
                      title="Broadway Youtube Compilation"
                      frameBorder="0"
              ...
              <Col sm={12}>
                ...
                >
                  <Card.Body>
                    ...
                    <p style={{ float: "right", padding: "0px", width: "70%" }}>
                      Show-Score simply and clearly organizes the information
                      you need to discover shows you’ll love, from people you
                      trust, at the right price for you.
                    </p>
                  </Card.Body>
                </Card>
              </Col>
